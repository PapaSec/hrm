<div class="min-h-screen bg-gradient-to-br from-slate-50 to-blue-50 dark:from-slate-900 dark:to-slate-800 p-6">
    <div class="relative mb-6 w-full">
        ...
        <flux:subheading size="lg" class="mb-6">Edit this employee</flux:subheading>
        <flux:separator />
    </div>
    ...
    <form wire:submit="save" class="my-6 w-full space-y-6">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <flux:input label="Employee Name" wire:model.live="employee.name" :invalid="$errors->has('employee.name')"
                type="text" />
            <flux:input label="Employee Email" wire:model.live="employee.email"
                :invalid="$errors->has('employee.email')" type="text" />
            ...
            <flux:select label="Designation" wire:model.live="employee.designation_id"
        ...
        <flux:input label="Employee Phone" wire:model.live="employee.phone" :invalid="$errors->has('employee.phone')"
            type="text" />
        <flux:input label="Employee Address" wire:model.live="employee.address"
